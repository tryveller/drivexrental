...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "DriveX — Two-wheeler rentals" },
      {
        name: "description",
        content:
          "Rent a scooter or bike from a DriveX hub near you. Weekly, monthly and rent-to-own plans.",
      },
      { name: "author", content: "DriveX" },
      { property: "og:title", content: "DriveX — Two-wheeler rentals" },
      {
        property: "og:description",
        content: "Rent a scooter or bike from a DriveX hub near you.",
      },
